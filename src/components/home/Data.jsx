...
const Data = () => {
  return (
    <div className="home__data">
                <h1 className='home__title'>Aman Worku 
                <svg
                  viewBox="0 0 48 48"
                  fill="none"
        ...
        <p className="home__description">A multi-skilled full-stack developer with hands-on experience in developing and maintaining web apps.  </p>
