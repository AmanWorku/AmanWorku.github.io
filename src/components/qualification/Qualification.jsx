            ...
            <div className="qualification__content qualification__content-active">
                <div className="qualification__data">
                    <div>
                        ...
                        <span className="qualification__subtitle">Debremarkos University - Ethiopia</span>
                ...
                <div className="qualification__data">
                    <div>
                        ...
                        <span className="qualification__subtitle">Microverse - Remote (SanFransisco)</span>
                        <div className="qualification__calendar">
                ...
                <div className="qualification__data">
                    ...
                    <div>
                        ...
                        <span className="qualification__subtitle">YeHiywet Kal Ministry</span>
                        <div className="qualification__calendar">
